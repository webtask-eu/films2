<nav>
  <ul>
    ...
    <li class="center nav-item-spacing"><a href="/collection_create.php"><?php echo translate('Create Collection'); ?></a></li>
    <li class="center nav-item-spacing"><a href="/collections.php"><?php echo translate('My Collections'); ?></a></li>
